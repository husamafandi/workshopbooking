...
$string['workshopnames_help'] = 'Einen Namen pro Zeile. Format: \'Name, TT.MM.JJJJ\' (eigenes Startdatum). Optional Zeit: \'Name, TT.MM.JJJJ HH:MM\' oder \'Name, TT.MM.JJJJ von HH:MM\' – Zeiten < 12:00 überschreiben nur den VM‑Start, Zeiten ≥ 12:00 nur den NM‑Start. Optional 3. Wert: \'URL\' – auf der Detailseite erscheint der Button \'Zum Workshop\'. Optional 4. Wert: \'Beschreibung\' – kurze Beschreibung für diesen Workshop (HTML erlaubt). Zeilenumbrüche in der Beschreibung: \'|\' oder \'
\'. Beispiel: \'DE, 01.11.2025 08:30, https://example.com, <p>Kurztext | weitere Zeile</p>\'. Für alle anderen Parameter gelten die Formulareinstellungen.';
