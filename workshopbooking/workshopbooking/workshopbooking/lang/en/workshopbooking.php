...
$string['workshopnames_help'] = 'Enter one name per line. Format: \'Name, DD.MM.YYYY\' (custom start date). Optional time: \'Name, DD.MM.YYYY HH:MM\' or \'Name, DD.MM.YYYY from HH:MM\' – times < 12:00 override the AM start, times ≥ 12:00 override the PM start. Optional 3rd value: \'URL\' – shows a \'Go to workshop\' button on the details page. Optional 4th value: \'Description\' – short per‑workshop description (HTML allowed). Line breaks in the description: \'|\' or \'
\'. Example: \'DE, 01.11.2025 08:30, https://example.com, <p>Short text | another line</p>\'. All other parameters follow the form settings.';
