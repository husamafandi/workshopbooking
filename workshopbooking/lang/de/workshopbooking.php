...
$string['workshopnames_help'] = 'Mehrere Workshops — ein Eintrag pro Zeile. Volles Format mit allen Werten:
Name, TT.MM.JJJJ HH:MM, URL, vm|nm|beides, Raum, Beschreibung

Beispiel:
Excel Grundlagen, 15.01.2026 09:00, https://example.com/excel, vm, R 1.01, Einführung | Bitte Laptop mitbringen
Python Aufbau, 16.01.2026 13:00, https://example.com/python, nm, R 2.12, Fortgeschrittene Themen | Übungen mit Datensätzen
Präsentieren kompakt, 20.01.2026 09:00, https://example.com/praes, beides, HS 3, Vormittag & Nachmittag als zwei Slots | Zertifikat am Ende
Datenschutz Update, 22.01.2026 09:00, https://example.com/dsgvo, vm, Online, Remote via Zoom | Link 24 h vorher per Mail

Spalten-Bedeutung: 1) Name  2) Datum/Uhrzeit (optional)  3) URL (optional)  4) Modus vm/nm/beides (optional)  5) Raum (optional)  6) Beschreibung (optional, Zeilenumbruch mit \'|\' oder \'\n\').';
...
$string['details_about'] = 'Informationen';

$string['workshop_shortdesc'] = 'Kurzbeschreibung';

$string['cta_goto_workshop'] = 'Zum Workshop';

$string['reminders'] = 'Erinnerungen';

$string['reminderenabled'] = 'Erinnerungs‑E-Mails senden';

$string['reminderamount'] = 'Anzahl';

$string['reminderunit'] = 'Einheit';

$string['remindersubject'] = 'Betreff der Erinnerung';

$string['remindertemplate'] = 'Textvorlage der Erinnerung (Platzhalter erlaubt)';

$string['remindertemplate_help'] = 'Platzhalter: [[fullname]], [[firstname]], [[workshopname]], [[sessiondate]], [[sessiontime]], [[coursefullname]], [[courseshortname]], [[courselink]].';

$string['mybookings'] = 'Meine Buchungen';

$string['downloadics'] = '.ics herunterladen';

$string['view_month'] = 'Monat';

$string['view_week'] = 'Woche';

$string['view_day'] = 'Tag';

$string['jump_to'] = 'Springen zu';

$string['slot_all'] = 'Alle Slots';

$string['slot_vm'] = 'VM';

$string['slot_nm'] = 'NM';

$string['showmybookingsbutton'] = 'Button „Meine Buchungen“ anzeigen';

$string['showmybookingsbutton_desc'] = 'Zeigt/verbirgt den Button auf der Hauptseite. Die Seite /mod/workshopbooking/mybookings.php bleibt weiterhin direkt aufrufbar.';

$string['blockeddates'] = 'Buchungs‑Sperrtage';

$string['blockeddates_desc'] = "Ein Datum pro Zeile, Format YYYY-MM-DD. Bereiche mit zwei Punkten: 2025-12-24..2026-01-06. Optional: mit Label, z. B. 2025-12-25 | Nationalfeiertag. Zeilen mit # sind Kommentare.";

$string['err_blockeddate'] = 'Für dieses Datum sind Buchungen gesperrt (Feiertag/Betriebsurlaub).';

$string['blocked_short'] = 'Buchung gesperrt';

$string['startlabel'] = 'Start:';

$string['durationlabel'] = 'Dauer:';

$string['btn_lock'] = 'Nicht buchbar';

$string['btn_unlock'] = 'Wieder buchbar';

$string['confirm_lock'] = 'Diesen Termin für Anmeldungen sperren?';

$string['locked_badge'] = 'nicht buchbar';

$string['locked_text'] = 'Für Anmeldungen gesperrt.';

$string['lock_set'] = 'Termin ist jetzt nicht buchbar.';

$string['lock_unset'] = 'Termin ist wieder buchbar.';
